...
public class LikeTransTest {
    ...
    // Positieve test: like toevoegen met type grappig
    @Test
    public void testLikesToevoegenTypeGrappig()
    {
        try
        {
        ...
        {
            System.out.println("testLikesToevoegenTypeGrappig - " + ex);
        }
    }
    
    // Positieve test: like toevoegen met type verbluft
    @Test
    public void testLikesToevoegenTypeVerbluft()
    {
        try
        {
        ...
        {
            System.out.println("testLikesToevoegenTypeVerbluft - " + ex);
        }
    }
    
    // Positieve test: like toevoegen met type verdrietig
    @Test
    public void testLikesToevoegenTypeVerdrietig()
    {
        try
        {
        ...
        {
            System.out.println("testLikesToevoegenTypeVerdrietig - " + ex);
        }
    }
    
    // Positieve test: like toevoegen met type boos
    @Test
    public void testLikesToevoegenTypeBoos()
    {
        try
        {
        ...
        {
            System.out.println("testLikesToevoegenTypeBoos - " + ex);
        }
    }
